// Auto-generated | 90 items | 2026-07-31
// Do not edit by hand.
...
export const actors: Actor[] = [
  ...
  },
  {
    "id": "wire-china",
    "layer": "bridge",
    "name_en": "The Wire China",
    "name_zh": "",
    "category": "Bridge – Publication / media",
    "overview": "An independent digital publication focused on business, economic, and policy coverage of China for a Western readership. Notable for its 'Who's Who' series profiling key figures across Chinese industries — including a comprehensive directory of 52 entrepreneurs, scientists, and policymakers shaping China's AI ecosystem, compiled from corporate documents, government statements, scholarly articles, and media reports. Also operates WireScreen, an AI-powered research platform for China corporate intelligence. The Who's Who AI directory covers leaders at DeepSeek, Zhipu AI, Moonshot, MiniMax, Baidu, Tencent, ByteDance, SenseTime, Huawei, and government officials including at MOST and CAS.",
    "leadership": [],
    "website": "https://www.thewirechina.com/",
    "short_name": "The Wire China"
  }
] as const;
