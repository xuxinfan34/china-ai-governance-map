...
export const strings = {
  en: {
    ...
    network_notice: "This graph shows verified institutional relationships among China-based ecosystem actors. Bridge and interpreter actors are directory-only for now; cross-border relationships are coming in a future release.",
  ...
  zh: {
    ...
    network_notice: "本图仅展示中国境内生态参与者之间已核实的机构关系。桥梁与解读者暂仅在名录中呈现,跨境关系将在后续版本推出。",
